...
<div class="p-8 space-y-8 max-w-[1600px] mx-auto">
	<div class="flex flex-wrap justify-between items-center gap-4 bg-card p-6 rounded-xl border shadow-sm">
        ...
        <div class="flex flex-wrap items-center gap-3 justify-end">
            ...
            <a href="/" class="px-5 py-2.5 bg-primary text-primary-foreground rounded-lg font-semibold hover:bg-primary/90 transition-all flex items-center gap-2 shadow-sm">
