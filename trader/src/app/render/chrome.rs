    ...
    pub(in crate::app) fn header_help_text(&self) -> String {
        ...
        let mut items = match self.screen {
            ...
            Screen::Analytics => vec![
                ...
                "Tab runs/trades/signals/sweeps".to_string(),
                "Up/Down select run/sweep".to_string(),
                "Left/Right fee scenario".to_string(),
                "m metric, f fee, d drawdown, t trades".to_string(),
                "j/k sweep candidate".to_string(),
                "[/] sweep source".to_string(),
                "s sort trades".to_string(),
                "g filter signals".to_string(),
