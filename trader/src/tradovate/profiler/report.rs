...
pub struct SwipeProfileOptions {
    ...
    pub bar_value: u32,
    pub require_simulation_proxy: bool,
...
pub(super) struct SwipeProfileReportOptions {
    ...
    pub(super) bar_value: u32,
    pub(super) require_simulation_proxy: bool,
    pub(super) allow_findings: bool,
...
pub(super) fn render_text_report(report: &SwipeProfileReport) -> String {
    ...
    out.push_str(&format!(
        "Options: simulation_proxy_required={} delays={:?} iterations_per_delay={} tp_ticks={} sl_ticks={} qty={} settle_timeout_ms={}\n\n",
        report.options.require_simulation_proxy,
