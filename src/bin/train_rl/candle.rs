...
pub fn run(args: Args, mut stack: ml::ResolvedTrainingStack) -> anyhow::Result<()> {
    ...
    let train_symbol = crate::data::read_symbol(&train_path)
    ...
    let train = crate::data::load_dataset_with_schema_and_bars(
        &train_path,
        use_globex,
        crate::data::ObservationSchema::NormalizedV2,
        bar_selection,
    )?;
    let val = crate::data::load_dataset_with_schema_and_bars(
        &val_path,
        use_globex,
        crate::data::ObservationSchema::NormalizedV2,
        bar_selection,
    )?;
    let test = crate::data::load_dataset_with_schema_and_bars(
        &test_path,
        use_globex,
        crate::data::ObservationSchema::NormalizedV2,
        bar_selection,
